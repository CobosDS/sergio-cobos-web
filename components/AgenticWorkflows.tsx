      ...
      <div className="max-w-5xl mx-auto">
        <div className="max-w-3xl mb-12">
          <p className="text-xs font-mono uppercase tracking-[0.25em] text-slate-500 mb-3">
            Documentation & service workflows
          </p>
          <h2 className="text-3xl font-bold text-white mb-3">
            Agentic <span className="text-blue-400">Workflows</span>
          </h2>
          <p className="text-sm text-slate-400 leading-relaxed">
            I build LLM-assisted workflows for documentation-heavy work: organizing knowledge,
            supporting customer-service processes, drafting reliable answers, and keeping human review
            where it matters.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-[1.15fr_0.85fr] gap-5 items-stretch">
          <div className="rounded-2xl border border-white/10 bg-[#0d1117] p-5 md:p-6 overflow-hidden">
            <div className="flex items-center justify-between gap-4 mb-6">
              <div>
                <h3 className="text-white font-semibold mb-1">Workflow graph</h3>
